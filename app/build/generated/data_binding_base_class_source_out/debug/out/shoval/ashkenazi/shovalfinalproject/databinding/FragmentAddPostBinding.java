...
public final class FragmentAddPostBinding implements ViewBinding {
  ...
  private FragmentAddPostBinding(@NonNull ScrollView rootView, @NonNull ImageButton btnAdd,
  ...
  public static FragmentAddPostBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAddPostBinding((ScrollView) rootView, btnAdd, btnAddImage, btnChange, btns,
          etGradients, etRecipe, etTitle, ivImage, lAddImage, lUpload, layoutInternal, spCategory,
          tvAdd, tvChange);
    }
